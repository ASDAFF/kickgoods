...
<?else:?>
	<input type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" class="styled-inpu1t" size="40" />
<?endif;?>
...
<!-- <?=GetMessage("SEARCH_GO")?> -->

&nbsp;<input type="submit" class="btn styled-submit" value="Найти" style="display:inline!important; padding:9px 12px" />
