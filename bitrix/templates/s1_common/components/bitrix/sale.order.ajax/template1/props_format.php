...
{
	function PrintPropsForm($arSource = array(), $locationTemplate = ".default",$CATALOG_SERVICES_ID=array(),$BASKET_SERVICES=array())
	{
		if (!empty($arSource))
		{
			?>
				<div>
					...
					foreach ($arSource as $arProperties)
					{
						...
						{
							if (($arProperties["CODE"] == "GREETING_TEXT" && isset($BASKET_SERVICES[$CATALOG_SERVICES_ID[0]])) or $arProperties["CODE"] != "GREETING_TEXT")
							{
