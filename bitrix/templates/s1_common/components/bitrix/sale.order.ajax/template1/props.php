...
<div class="bx_section">
	...
	<div id="sale_order_props">
		<?
		PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_N"], $arParams["TEMPLATE_LOCATION"],$CATALOG_SERVICES_ID,$BASKET_SERVICES);
		PrintPropsForm($arResult["ORDER_PROP"]["USER_PROPS_Y"], $arParams["TEMPLATE_LOCATION"],$CATALOG_SERVICES_ID,$BASKET_SERVICES);
		?>
	</div>
</div>
